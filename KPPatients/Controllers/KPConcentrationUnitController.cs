...
{
    public class KPConcentrationUnitController : Controller
    {
        private readonly PatientsContext _context;

        public KPConcentrationUnitController(PatientsContext context)
        {
            _context = context;
        }
        // this function displays all the details of cocentration unit controller.
        // GET: KPConcentrationUnit
        public async Task<IActionResult> Index()
        {
              return View(await _context.ConcentrationUnits.ToListAsync());
        }
        // this shows the details of cocentration unit.
        // GET: KPConcentrationUnit/Details/5
        public async Task<IActionResult> Details(string id)
        {
            ...
            // after click on details then its displays.
            return View(concentrationUnit);
        }

        // GET: KPConcentrationUnit/Create
        public IActionResult Create()
        {
            return View();
        }
        // for create a new contration unit.
        // POST: KPConcentrationUnit/Create
        ...
        // in this we can edit existing concentration unit.
        // GET: KPConcentrationUnit/Edit/5
        ...
        // POST: KPConcentrationUnit/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // We can use this function for delete the one of the unit.
        // GET: KPConcentrationUnit/Delete/5
        ...
        // POST: KPConcentrationUnit/Delete/5
